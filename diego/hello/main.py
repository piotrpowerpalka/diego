...
async def main():
    ...
    auc_bystar = Auctionee(f"bystar_auctionee@{DEFAULT_HOST}", AGENT_PASSWORD, {"active": "not_controllable", "reactive": "not_controllable", "device_manager": "bystar_device", "auction_operator": "auction_operator"}, verify_security=False)
    auc_byprint = Auctionee(f"byprint_auctionee@{DEFAULT_HOST}", AGENT_PASSWORD, {"active": "not_controllable", "reactive": "not_controllable", "device_manager": "byprint_device", "auction_operator": "auction_operator"}, verify_security=False)
